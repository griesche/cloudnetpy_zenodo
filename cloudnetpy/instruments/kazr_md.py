...
def kazr_md2nc(
    ...
    """Converts ARM KAZR cloud radar data from medium sensitivity mode into Cloudnet Level 1b netCDF file.
    ...
    Examples:
          ...
          >>> kazr_md2nc('raw_radar.nc', 'radar.nc', site_meta)
          >>> kazr_md2nc('/one/day/of/kazr/nc/files/', 'radar.nc', site_meta)
    ...
    calibration_offset = site_meta.get("calibration_offset", 6)
