...
def kazr_ge2nc(
    ...
    """Converts ARM KAZR cloud radar data from general mode into Cloudnet Level 1b netCDF file.
    ...
    Examples:
          ...
          >>> kazr_ge2nc('raw_radar.nc', 'radar.nc', site_meta)
          >>> kazr_ge2nc('/one/day/of/kazr/nc/files/', 'radar.nc', site_meta)
    ...
    calibration_offset = site_meta.get("calibration_offset", 1)
