...
CATEGORIZE_ATTRIBUTES = {
    ...
    "Z_error": MetaData(
        long_name="Error in radar reflectivity factor", units="dB", comment=COMMENTS["Z_error"]
    ),
    "Z_bias": MetaData(
        long_name="Bias in radar reflectivity factor", units="dB", comment=COMMENTS["bias"]
    ),
    ...
    "v_sigma": MetaData(long_name="Standard deviation of mean Doppler velocity", units="m s-1"),
    # Lidar variables
    "beta": MetaData(
    ...
    "model_height": MetaData(
        long_name="Height of model variables above mean sea level", units="m", axis="Z"
    ),
    "vwind": MetaData(
